    ...
    >
      <div className="flex items-center gap-3 border-b border-white/10 pb-4">
        ...
        <div className="min-w-0">
          <p className="text-xs font-semibold uppercase tracking-wider opacity-75">{subtitle || 'Carte de fidélité'}</p>
      ...
      <div className="overflow-hidden rounded-xl shadow-inner">{qrBlock}</div>
    </div>
  )
}
